...
import { Cormorant_Garamond, DM_Sans, Anton, Pinyon_Script } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${cormorant.variable} ${dmSans.variable} ${anton.variable} ${pinyonScript.variable}`}
    >
